...
void TpcDirectLaserReconstruction::create_histograms()
{
  ...
  h_relangle_phi_lasrangle = new TH2F("relangle_phi_lasrangle","#delta#phi from laser and relative angle histogram for LASER 1 ONLY",91,-0.5,90.5,361,-0.5,350.5);
...
*/
  ...
  if( trkid == 0 && h_deltheta_delphi_1->GetEntries() > 0)
  {
  ...
  else if( trkid == 1 && h_deltheta_delphi_2->GetEntries() > 0 )
  {
  ...
  else if( trkid == 2 && h_deltheta_delphi_3->GetEntries() > 0 )
  {
  ...
  else if( trkid == 3 && h_deltheta_delphi_4->GetEntries() > 0 )
  {
  ...
  else if( trkid == 4 && h_deltheta_delphi_5->GetEntries() > 0 )
  {
  ...
  else if( trkid == 5 && h_deltheta_delphi_6->GetEntries() > 0 )
  {
  ...
  else if( trkid == 6 && h_deltheta_delphi_7->GetEntries() > 0 )
  {
  ...
  else if( trkid == 7 && h_deltheta_delphi_8->GetEntries() > 0 )
  {
